async function selectCategoryById(event) {
  ...
  const categoryId = document.querySelector(
    ".expense-category-form option:checked"
  ).value;
  const sessionUserId = document.querySelector("#user_id").value;
  let getNewTransactionElement = document.querySelector(
...
document
  .querySelector(".expense-category-form")
  .addEventListener("submit", selectCategoryById);
